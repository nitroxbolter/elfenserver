local config = {
    actionId = 30039, 
    bossName = "forbidden chevalier",
    bossPosition = Position(1099, 1628, 10), 
    bossArea = {
        fromPos = Position(1083, 1613, 10), 
        toPos = Position(1115, 1639, 10), 
        entrancePos = Position(1093, 1628, 10), 
        exitPosition = Position(1093, 411, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1024, 1626, 10),
        Position(1024, 1627, 10),
        Position(1024, 1628, 10), 
        Position(1024, 1629, 10) 
    },
    attempts = {
        level = 500, 
        storage = 720007, 
    ...
    createTeleportPos = Position(1097, 1620, 10), 
    teleportToPosition = Position(1093, 411, 7), 
...
local forbiddenChevalier = Action()

function forbiddenChevalier.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("forbiddenDeath")
...
forbiddenChevalier:aid(config.actionId)
forbiddenChevalier:register()

local creatureEvent = CreatureEvent("forbiddenDeath")
