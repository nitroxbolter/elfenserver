local config = {
    ...
    bossPosition = Position(1446, 1655, 12), 
    bossArea = {
        fromPos = Position(1409, 1623, 12), 
        toPos = Position(1467, 1675, 12), 
        entrancePos = Position(1434, 1639, 12), 
        exitPosition = Position(1093, 411, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1431, 1640, 11),
        Position(1431, 1641, 11),
        Position(1431, 1642, 11), 
        Position(1431, 1643, 11) 
    },
    attempts = {
        level = 500, 
        storage = 720010, 
    ...
    createTeleportPos = Position(1429, 1635, 12),  
...
local rootKraken = Action()

function rootKraken.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("rootKrakenDeath")
...
rootKraken:aid(config.actionId)
rootKraken:register()

local creatureEvent = CreatureEvent("rootKrakenDeath")
