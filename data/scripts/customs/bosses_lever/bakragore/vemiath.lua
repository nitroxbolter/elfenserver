local config = {
    actionId = 43019, 
    bossName = "Vemiath",
    bossPosition = Position(2508, 1256, 12), 
    bossArea = {
        fromPos = Position(2501, 1247, 12), 
        toPos = Position(2517, 1264, 12), 
        entrancePos = Position(2508, 1261, 12), 
        exitPosition = Position(2508, 1279, 12) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(2507, 1277, 12),
        Position(2508, 1277, 12),
        Position(2509, 1277, 12), 
        Position(2510, 1277, 12)
    },
    attempts = {
        level = 100, 
        storage = 710051, 
    ...
    createTeleportPos = Position(2508, 1251, 12), 
    teleportToPosition = Position(2508, 1279, 12), 
