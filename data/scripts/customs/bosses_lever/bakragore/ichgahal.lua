local config = {
    actionId = 43020, 
    bossName = "Ichgahal",
    bossPosition = Position(2320, 1144, 11), 
    bossArea = {
        fromPos = Position(2310, 1135, 11), 
        toPos = Position(2330, 1153, 11), 
        entrancePos = Position(2320, 1150, 11), 
        exitPosition = Position(2273, 1135, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(2272, 1139, 11),
        Position(2273, 1139, 11),
        Position(2274, 1139, 11), 
        Position(2275, 1139, 11)
    },
    attempts = {
        level = 100, 
        storage = 710043, 
    ...
    createTeleportPos = Position(2317, 1138, 11), 
    teleportToPosition = Position(2273, 1135, 11), 
