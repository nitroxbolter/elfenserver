local config = {
    actionId = 43022, 
    bossName = "Bakragore",
    bossPosition = Position(2338, 1157, 8), 
    bossArea = {
        fromPos = Position(2325, 1146, 8), 
        toPos = Position(2353, 1167, 8), 
        entrancePos = Position(2329, 1155, 8), 
        exitPosition = Position(2283, 1140, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(2282, 1142, 8),
        Position(2283, 1142, 8),
        Position(2284, 1142, 8), 
        Position(2285, 1142, 8)
    },
    attempts = {
        level = 100, 
        storage = 710091, 
    ...
    createTeleportPos = Position(2347, 1151, 8), 
    teleportToPosition = Position(2283, 1140, 8), 
...
local bakragoreLever = Action()

function bakragoreLever.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("bakragoreBossLever")
...
bakragoreLever:aid(config.actionId)
bakragoreLever:register()

local creatureEvent = CreatureEvent("bakragoreBossLever")
