local config = {
    ...
    bossPosition = Position(1587, 552, 9), 
    bossArea = {
        fromPos = Position(1574, 541, 9), 
        toPos = Position(1602, 564, 9), 
        entrancePos = Position(1588, 560, 9), 
        exitPosition = Position(1617, 553, 9) 
    },
    ...
    createTeleportPos = Position(1586, 544, 9), 
    teleportToPosition = Position(1617, 553, 9), 
