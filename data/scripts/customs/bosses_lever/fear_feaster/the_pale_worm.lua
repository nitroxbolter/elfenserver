local config = {
    ...
    bossPosition = Position(1686, 519, 9), 
    bossArea = {
        fromPos = Position(1675, 508, 9), 
        toPos = Position(1702, 532, 9), 
        entrancePos = Position(1686, 528, 9), 
        exitPosition = Position(1653, 520, 9) 
    },
    ...
    createTeleportPos = Position(1685, 511, 9), 
    teleportToPosition = Position(1653, 520, 9), 
...
local thePaleAction = Action()

function thePaleAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("thePaleSystemDeath")
...
thePaleAction:aid(config.actionId)
thePaleAction:register()

local creatureEvent = CreatureEvent("thePaleSystemDeath")
