local config = {
    actionId = 27103, 
    bossName = "lokathmor",
    bossPosition = Position(892, 1625, 9), 
    bossArea = {
        fromPos = Position(882, 1614, 9), 
        toPos = Position(902, 1636, 9), 
        entrancePos = Position(892, 1633, 9), 
        exitPosition = Position(890, 1649, 9) 
    },
    ...
    createTeleportPos = Position(892, 1618, 9), 
    teleportToPosition = Position(890, 1649, 9), 
...
local lokathmorAction = Action()

function lokathmorAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("lokathmorSystemDeath")
...
lokathmorAction:aid(config.actionId)
lokathmorAction:register()

local creatureEvent = CreatureEvent("lokathmorSystemDeath")
