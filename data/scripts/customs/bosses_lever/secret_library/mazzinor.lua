local config = {
    actionId = 27104, 
    bossName = "mazzinor",
    bossPosition = Position(855, 1623, 9), 
    bossArea = {
        fromPos = Position(839, 1607, 9), 
        toPos = Position(873, 1640, 9), 
        entrancePos = Position(855, 1630, 9), 
        exitPosition = Position(890, 1673, 9) 
    },
    ...
    createTeleportPos = Position(855, 1617, 9), 
    teleportToPosition = Position(890, 1673, 9), 
...
local mazzinorAction = Action()

function mazzinorAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("mazzinorSystemDeath")
...
mazzinorAction:aid(config.actionId)
mazzinorAction:register()

local creatureEvent = CreatureEvent("mazzinorSystemDeath")
