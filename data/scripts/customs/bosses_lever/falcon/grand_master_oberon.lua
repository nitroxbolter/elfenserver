local config = {
    ...
    bossPosition = Position(728, 134, 8), 
    bossArea = {
        fromPos = Position(718, 128, 8), 
        toPos = Position(739, 147, 8), 
        entrancePos = Position(728, 143, 8), 
        exitPosition = Position(728, 162, 8) 
    },
    ...
    createTeleportPos = Position(728, 144, 8), 
    teleportToPosition = Position(728, 162, 8), 
...
function gorzindelAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("grandMasterOberonDeath")
...
local creatureEvent = CreatureEvent("grandMasterOberonDeath")
