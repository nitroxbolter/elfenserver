local config = {
    actionId = 27107, 
    bossName = "furious scorpion",
    bossPosition = Position(1872, 491, 8), 
    bossArea = {
        fromPos = Position(1869, 485, 8), 
        toPos = Position(1887, 497, 8), 
        entrancePos = Position(1885, 491, 8), 
        exitPosition = Position(1890, 493, 8) 
    },
    ...
    createTeleportPos = Position(1871, 491, 8), 
    teleportToPosition = Position(1890, 493, 8), 
...
local furiousScorpion = Action()

function furiousScorpion.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("furiousScorpionDeath")
...
furiousScorpion:aid(config.actionId)
furiousScorpion:register()

local creatureEvent = CreatureEvent("furiousScorpionDeath")
