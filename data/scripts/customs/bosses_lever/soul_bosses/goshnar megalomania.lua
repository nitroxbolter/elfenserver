local config = {
    ...
    bossPosition = Position(1460, 654, 10), 
    bossArea = {
        fromPos = Position(1450, 643, 10), 
        toPos = Position(1471, 665, 10), 
        entrancePos = Position(1461, 661, 10), 
        exitPosition = Position(1427, 656, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1426, 654, 10),
        Position(1427, 654, 10),
        Position(1427, 654, 10), 
        Position(1427, 654, 10),
        Position(1427, 654, 10)
    },
    ...
    createTeleportPos = Position(1461, 646, 10), 
    teleportToPosition = Position(1427, 656, 10), 
...
local goshnarMegalomania = Action()

function goshnarMegalomania.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarMegalomaniaDeath")
...
goshnarMegalomania:aid(config.actionId)
goshnarMegalomania:register()

local creatureEvent = CreatureEvent("goshnarMegalomaniaDeath")
