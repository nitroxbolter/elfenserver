local config = {
    ...
    bossPosition = Position(1917, 544, 7), 
    bossArea = {
        fromPos = Position(1906, 536, 7), 
        toPos = Position(1927, 554, 7), 
        entrancePos = Position(1916, 552, 7), 
        exitPosition = Position(1917, 545, 6) 
    },
    ...
    createTeleportPos = Position(1916, 538, 7), 
    teleportToPosition = Position(1917, 545, 6), 
...
function goshnarCruelty.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarCrueltyDeath")
...
goshnarCruelty:aid(config.actionId)
goshnarCruelty:register()

local creatureEvent = CreatureEvent("goshnarCrueltyDeath")
