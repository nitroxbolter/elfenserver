local config = {
    ...
    bossPosition = Position(1493, 619, 10), 
    bossArea = {
        fromPos = Position(1481, 610, 10), 
        toPos = Position(1505, 628, 10), 
        entrancePos = Position(1493, 625, 10), 
        exitPosition = Position(1525, 619, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1523, 621, 10),
        Position(1524, 621, 10),
        Position(1525, 621, 10), 
        Position(1526, 621, 10),
        Position(1527, 621, 10)
    },
    attempts = {
        level = 200, 
        storage = 720041, 
    ...
    createTeleportPos = Position(1493, 614, 10), 
    teleportToPosition = Position(1525, 619, 10), 
    teleportRemoveSeconds = 60, 
    kickParticipantAfterSeconds = 60 * 25, 
    leverIds = {9825, 9826} 
}
...
local goshnarHatred = Action()

function goshnarHatred.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarHatredDeath")
...
goshnarHatred:aid(config.actionId)
goshnarHatred:register()

local creatureEvent = CreatureEvent("goshnarHatredDeath")
