local config = {
    ...
    bossPosition = Position(1496, 685, 10), 
    bossArea = {
        fromPos = Position(1486, 676, 10), 
        toPos = Position(1509, 697, 10), 
        entrancePos = Position(1497, 692, 10), 
        exitPosition = Position(1528, 683, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1526, 685, 10),
        Position(1527, 685, 10),
        Position(1528, 685, 10), 
        Position(1529, 685, 10),
        Position(1530, 685, 10)
    },
    attempts = {
        level = 200, 
        storage = 720045, 
    ...
    createTeleportPos = Position(1488, 684, 10), 
    teleportToPosition = Position(1528, 683, 10), 
...
local goshnarGreed = Action()

function goshnarGreed.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarGreedDeath")
...
goshnarGreed:aid(config.actionId)
goshnarGreed:register()

local creatureEvent = CreatureEvent("goshnarGreedDeath")
