local config = {
    ...
    bossPosition = Position(1492, 652, 10), 
    bossArea = {
        fromPos = Position(1478, 640, 10), 
        toPos = Position(1506, 665, 10), 
        entrancePos = Position(1492, 659, 10), 
        exitPosition = Position(1526, 652, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1524, 654, 10),
        Position(1525, 654, 10),
        Position(1526, 654, 10), 
        Position(1527, 654, 10),
        Position(1528, 654, 10)
    },
    attempts = {
        level = 200, 
        storage = 720042, 
    ...
    createTeleportPos = Position(1493, 645, 10), 
    teleportToPosition = Position(1526, 652, 10), 
...
local goshnarSpite = Action()

function goshnarSpite.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarSpiteDeath")
...
goshnarSpite:aid(config.actionId)
goshnarSpite:register()

local creatureEvent = CreatureEvent("goshnarSpiteDeath")
