local config = {
    ...
    bossPosition = Position(1459, 618, 10), 
    bossArea = {
        fromPos = Position(1449, 608, 10), 
        toPos = Position(1471, 630, 10), 
        entrancePos = Position(1459, 627, 10), 
        exitPosition = Position(1430, 617, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1429, 619, 10),
        Position(1430, 619, 10),
        Position(1431, 619, 10), 
        Position(1432, 619, 10),
        Position(1433, 619, 10)
    },
    attempts = {
        level = 200, 
        storage = 720040, 
    ...
    createTeleportPos = Position(1458, 611, 10), 
    teleportToPosition = Position(1430, 617, 10), 
...
function goshnarMalice.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarMaliceDeath")
...
goshnarMalice:aid(config.actionId)
goshnarMalice:register()

local creatureEvent = CreatureEvent("goshnarMaliceDeath")
