local config = {
    actionId = 42582, 
    bossName = "earl osam",
    bossPosition = Position(893, 419, 9), 
    bossArea = {
        fromPos = Position(883, 407, 9), 
        toPos = Position(906, 430, 9), 
        entrancePos = Position(893, 427, 9), 
        exitPosition = Position(922, 419, 9) 
    },
    ...
    createTeleportPos = Position(885, 419, 9), 
    teleportToPosition = Position(922, 419, 9), 
...
local earlOsamAction = Action()

function earlOsamAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("earlOsamSystemDeath")
...
earlOsamAction:aid(config.actionId)
earlOsamAction:register()

local creatureEvent = CreatureEvent("earlOsamSystemDeath")
