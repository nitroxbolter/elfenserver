local config = {
    ...
    bossPosition = Position(861, 418, 9), 
    bossArea = {
        fromPos = Position(851, 407, 9), 
        toPos = Position(873, 429, 9), 
        entrancePos = Position(861, 410, 9), 
        exitPosition = Position(861, 389, 9) 
    },
    ...
    createTeleportPos = Position(853, 418, 9), 
    teleportToPosition = Position(861, 389, 9), 
...
local countVlarAction = Action()

function countVlarAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("countVlarSystemDeath")
...
countVlarAction:aid(config.actionId)
countVlarAction:register()

local creatureEvent = CreatureEvent("countVlarSystemDeath")
