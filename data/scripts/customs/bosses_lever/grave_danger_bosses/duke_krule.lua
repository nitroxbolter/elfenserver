local config = {
    actionId = 42585, 
    bossName = "duke krule",
    bossPosition = Position(861, 453, 9), 
    bossArea = {
        fromPos = Position(850, 442, 9), 
        toPos = Position(872, 465, 9), 
        entrancePos = Position(861, 462, 9), 
        exitPosition = Position(861, 478, 9) 
    },
    ...
    createTeleportPos = Position(853, 454, 9), 
    teleportToPosition = Position(861, 478, 9), 
...
local dukeKruleAction = Action()

function dukeKruleAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("dukeKruleSystemDeath")
...
dukeKruleAction:aid(config.actionId)
dukeKruleAction:register()

local creatureEvent = CreatureEvent("dukeKruleSystemDeath")
