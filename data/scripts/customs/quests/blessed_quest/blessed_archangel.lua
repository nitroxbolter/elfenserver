local config = {
    actionId = 43030, 
    bossName = "blessed archangel",
    bossPosition = Position(819, 1869, 10), 
    bossArea = {
        fromPos = Position(811, 1861, 10), 
        toPos = Position(829, 1876, 10), 
        entrancePos = Position(827, 1869, 10), 
        exitPosition = Position(836, 1866, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(833, 1868, 10),
        Position(833, 1869, 10),
        Position(833, 1870, 10), 
        Position(833, 1871, 10), 
    },
    attempts = {
        level = 200, 
        storage = 720036, 
    ...
    createTeleportPos = Position(817, 1869, 10), 
    teleportToPosition = Position(836, 1848, 10), 
    teleportRemoveSeconds = 160, 
...
local archangelBlessed = Action()

function archangelBlessed.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("archangelBlessedDeath")
...
archangelBlessed:aid(config.actionId)
archangelBlessed:register()

local creatureEvent = CreatureEvent("archangelBlessedDeath")
