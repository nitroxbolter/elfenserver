local config = {
    actionId = 42637, 
    bossName = "Mercurial Mage",
    bossPosition = Position(930, 2059, 12), 
    bossArea = {
        fromPos = Position(923, 2056, 12), 
        toPos = Position(939, 2086, 12), 
        entrancePos = Position(930, 2080, 12), 
        exitPosition = Position(896, 2065, 12) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(905, 2067, 12),
        Position(904, 2068, 12),
        Position(905, 2068, 12),
        Position(906, 2068, 12),
    },
    attempts = {
        level = 200, 
        storage = 720073, 
    ...
    createTeleportPos = Position(930, 2057, 12), 
    teleportToPosition = Position(929, 2055, 12), 
...
local mercurialBoss = Action()

function mercurialBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("mercurialDeath")
...
mercurialBoss:aid(config.actionId)
mercurialBoss:register()

local creatureEvent = CreatureEvent("mercurialDeath")
