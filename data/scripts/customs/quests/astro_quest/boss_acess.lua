local config = {
    actionId = 42635, 
    bossName = "Astro King",
    bossPosition = Position(238, 1606, 12), 
    bossArea = {
        fromPos = Position(224, 1593, 12), 
        toPos = Position(258, 1627, 12), 
        entrancePos = Position(238, 1618, 12), 
        exitPosition = Position(242, 1601, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(246, 1609, 10),
        Position(245, 1610, 10),
        Position(246, 1610, 10),
        Position(247, 1610, 10),
    },
    attempts = {
        level = 200, 
        storage = 720070, 
    ...
    createTeleportPos = Position(238, 1600, 12), 
    teleportToPosition = Position(171, 1605, 5), 
