local config = {
    actionId = 42639, 
    bossName = "Candy Fairy",
    bossPosition = Position(208, 1995, 8), 
    bossArea = {
        fromPos = Position(198, 1980, 8), 
        toPos = Position(221, 2004, 8), 
        entrancePos = Position(208, 1983, 8), 
        exitPosition = Position(246, 2006, 8) 
    },
    ...
    createTeleportPos = Position(207, 1996, 8), 
    teleportToPosition = Position(207, 1998, 8), 
...
function sugarDaddy.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("candyFairyDeath")
...
local creatureEvent = CreatureEvent("candyFairyDeath")
